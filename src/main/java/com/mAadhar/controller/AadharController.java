...
public class AadharController {
	...
	@PatchMapping(value = "updateVerified/{cid}/{verified}")
	public String updateVerified(@PathVariable("cid") int cid, @PathVariable("verified") boolean verified) {
	    return aadharService.updateAadharVerification(cid, verified);
	}

	@PatchMapping(value = "updateApproved/{cid}/{approved}")
	public String updateApproved(@PathVariable("cid") int cid, @PathVariable("approved") boolean approved) {
	    return aadharService.updateAadharApproval(cid, approved);
	}
